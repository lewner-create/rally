    ...
    <>
      ...
      <form action={action} className="space-y-4">
        ...
        <div className="space-y-1.5">
          ...
          <Input
            id="displayName" name="displayName" required className="h-10"
        ...
        <div className="space-y-1.5">
          ...
          <div className="relative">
            ...
            <Input
              id="username" name="username" className="pl-7 h-10" required
        ...
        <div className="space-y-1.5">
          ...
          <Input
            id="email" name="email" type="email" autoComplete="email" required className="h-10"
        ...
        <div className="space-y-1.5">
          ...
          <Input
            ...
            autoComplete="new-password" required className="h-10"
          />
